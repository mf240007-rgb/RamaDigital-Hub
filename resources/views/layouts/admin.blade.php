...
<head>
    ...
    <style>
        ...
        .sidebar-brand { padding: 20px 15px; border-bottom: 1px solid rgba(255,255,255,0.1); font-size: 1.1rem; font-weight: 700; }
        .sidebar-brand span { color: var(--warna-aksen); }
        .sidebar-brand img { display: inline-block; height: 34px; width: auto; margin-right: 8px; vertical-align: middle; }
        ...
        <div class="row g-0">
            <div class="col-md-3 col-lg-2 sidebar">
                <div class="sidebar-brand">
                    <img src="{{ asset('images/brand/rd-logo.svg') }}" alt="RD Logo">
